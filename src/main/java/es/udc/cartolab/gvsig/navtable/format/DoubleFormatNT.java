...
public class DoubleFormatNT {
	...
	static {
		bigDecimalFormat = (DecimalFormat) NumberFormat.getNumberInstance(Locale.getDefault());
	...
	public static NumberFormat getEditingFormat() {
		if (doubleFormatOnEdit == null) {
			doubleFormatOnEdit = (DecimalFormat) NumberFormat.getNumberInstance(Locale.getDefault());
